...
\hline
%\parbox[c]{\hsize}{\vskip7pt {\lantxh 2型糖尿病\\ \bahao HASH(0x253fd38)} \vskip7pt} 
...
\hline
%\parbox[c]{\hsize}{\vskip7pt {\lantxh 炎症性肠病\\ \bahao HASH(0x2542d70)} \vskip7pt} 
...
\begin{minipage}{4cm}\begin{center}{{\lantxh 正常} }\end{center} \end{minipage} \\
\hline
%\parbox[c]{\hsize}{\vskip7pt {\lantxh 高血压\\ \bahao HASH(0x2542e90)} \vskip7pt} 
