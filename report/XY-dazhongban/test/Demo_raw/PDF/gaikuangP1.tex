...
\put(3.35132258064516,0.55){\includegraphics[scale=1]{straw_l2.pdf}}
...
& \parbox[c]{\hsize}{\vskip7pt {您的肠道菌群多样性偏低，说明您的肠道菌群组成较为单一，菌群失调风险较高。您的肠道菌群较易受到外界因素的干扰（如不良作息、刺激性食物、药物滥用），可能会导致菌群失调，引起胃肠道炎症、免疫力低下、胰岛素抵抗等多种健康问题。} \vskip7pt} \\
\end{tabular}
