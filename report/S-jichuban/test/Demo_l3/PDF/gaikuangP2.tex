...
\end{tikzpicture}
\begin{center}
\pdfchatuoliver{xiaoren0}{9}\includegraphics[width=.35cm]{xiaoren04.pdf}

\textbf{\small 您的有益菌含量高于93.75{\%}的参考人群 }
\end{center}
\end{minipage}
\hfill
\begin{minipage}[t]{.47\textwidth}
...
\begin{center}
\pdfchatuorange{xiaoren1}{3}\includegraphics[width=.35cm]{xiaoren16.pdf}
\pdfchatu{xiaoren1}{6}

\textbf{\small 您的有害菌含量高于35.97{\%}的参考人群}
\end{center}
\end{minipage}
