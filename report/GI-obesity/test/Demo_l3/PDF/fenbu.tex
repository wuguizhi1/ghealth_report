...
\hline
%\parbox[c]{\hsize}{\vskip7pt {\lantxh 肠杆菌属\\ \bahao HASH(0x193d3f8)} \vskip7pt} 
...
\begin{minipage}{4cm}\begin{center}{{\lantxh 偏低} }\end{center} \end{minipage} \\
\hline
%\parbox[c]{\hsize}{\vskip7pt {\lantxh 沙门氏菌属\\ \bahao HASH(0x193db78)} \vskip7pt} 
...
\hline
%\parbox[c]{\hsize}{\vskip7pt {\lantxh 志贺氏菌属\\ \bahao HASH(0x193df38)} \vskip7pt} 
...
\begin{minipage}{4cm}\begin{center}{{\lantxh 偏低} }\end{center} \end{minipage} \\
\hline
%\parbox[c]{\hsize}{\vskip7pt {\lantxh 克里斯滕森菌属\\ \bahao HASH(0x1941de0)} \vskip7pt} 
