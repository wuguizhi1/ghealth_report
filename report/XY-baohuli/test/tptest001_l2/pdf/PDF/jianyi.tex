...
{\fontsize{9pt}{11pt}\selectfont\bf {综合您本次检测结果，肠道有益菌总得分为63分，
不利于肠道及人体健康，
4种有益菌属的检测指数均偏低，需注意。
建议您：}}
\end{spacing}
...
{\includegraphics[scale=1.0]{xiaofangkuai.pdf}\fontsize{8pt}{10pt}\selectfont \ 建议您在日常饮食中选择补充山药、玉米、燕麦、南瓜、芹菜等食物或者相关的加工提取食品，为肠道菌群提供更多营养，促进有益共生菌的生长，增加肠道菌群的丰富度及多样性。\\}
...
{\includegraphics[scale=1.0]{xiaofangkuai.pdf}\fontsize{8pt}{10pt}\selectfont \ 建议您选择补充低聚果糖、菊粉、富含多酚的蔓越莓提取物等益生元，能帮助柔嫩梭菌属、阿克曼氏菌属、双歧杆菌属、乳酸杆菌属在肠道内增殖，增加有益物质的产生，有利于增强肠道屏障功能，促进肠道健康。\\}
