...
\put(0,5.7){\bfseries 您的肠道菌群多样性为：3.20（参考范围：1.50-4.41）}
%\put(0,5.7){\bfseries 您的肠道菌群多样性为：3.20}
\put(0,0){\includegraphics[width=.65\linewidth]{normalDistribution.pdf}}
\put(5.44,.5){\includegraphics[width=1.29cm]{location.pdf}}
\put(10.7,.5){\includegraphics[width=1.29cm]{diversity50.pdf}}
\put(10.7,4.5){\parbox{2cm}{\color{topcolor}\bfseries 您的数值高\\于52.47{\%}\\的参考人群。}}
