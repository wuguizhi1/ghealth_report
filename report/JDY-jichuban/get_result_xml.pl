...
sub sample_result {
	...
	if ($vars->{abundance}{pearson_cor} > 0.92) {
		$part2 .= "人体肠道中超过98%的菌群归属于以下四个菌门，拟杆菌门、厚壁菌门、变形菌门和放线菌门，厚壁菌门/拟杆菌门（FBR）比值根据研究表明与肥胖风险正相关。您的肠道菌群相对丰度性与参考人群趋势一致，说明您的肠道菌群组成结构及稳定性良好，有利于肠道及人体健康。您的肠道菌群不易受到外界不良因素的干扰，但请避免不良作息、刺激性食物、药物滥用等，这样有助于保持良好的肠道菌群相对丰度，维持肠道微生态健康。";
	}
	elsif ($vars->{abundance}{pearson_cor} > 0.8) {
		$part2 .= "人体肠道中超过98%的菌群归属于以下四个菌门，拟杆菌门、厚壁菌门、变形菌门和放线菌门，厚壁菌门/拟杆菌门（FBR）比值根据研究表明与肥胖风险正相关。您的肠道菌群相对丰度性与参考人群趋势相似，说明您的肠道菌群组成结构较好，不易受到外界不良因素的干扰，但仍需要遵循良好的饮食及生活习惯，避免不良作息、刺激性食物、药物滥用等，有助于优化肠道菌群组成结构，并保持较好的肠道菌群相对丰度，维持肠道微生态健康。";
	}
	else {
		$part2 .= "人体肠道中超过98%的菌群归属于以下四个菌门，拟杆菌门、厚壁菌门、变形菌门和放线菌门，厚壁菌门/拟杆菌门（FBR）比值根据研究表明与肥胖风险正相关。您肠道菌群门水平含量与参考人群趋势存在差异，说明您的肠道菌群组成可能引起肠道问题，如腹泻、腹痛、腹胀等。您的肠道菌群较易受到外界不良因素的干扰，需通过饮食调理、按时作息以及合理运动等良好生活方式调理肠道菌群结构，改善肠道微生态健康。";
	}
