...
{\fontsize{9pt}{11pt}\selectfont\bf {综合您本次检测结果，肠道益生菌总得分为48分，
不利于肠道及人体健康，
4种益生菌属的检测指数均偏低，需注意。
建议您：}}
\end{spacing}
...
{\includegraphics[scale=1.0]{xiaofangkuai.pdf}\fontsize{8pt}{10pt}\selectfont \ 建议您在日常饮食中选择补充糙米、南瓜、四季豆等食物或者相关的加工提取食品，为肠道菌群提供更多营养，促进有益共生菌的生长，增加肠道菌群的丰富度及多样性。\\}
