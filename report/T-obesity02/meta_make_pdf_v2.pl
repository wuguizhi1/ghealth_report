...
&make_pdf($xml,"fenbu",$templateDir,$dirout,\@context3);

#### 潜在疾病风险
&make_pdf($xml,"jibingfengxian",$templateDir,$dirout,\@context4);

#### 调节方案建议
&make_pdf($xml,"tiaojiefangan",$templateDir,$dirout,\@context5);
...
&output_contexts("$dirout/contexts4",\@context5);
