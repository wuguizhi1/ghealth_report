...
{\fontsize{10pt}{11pt}\selectfont\bf {综合您本次肠道有益菌检测，您肠道健康保护力总得分为16.01分，
不利于肠道及人体健康，
4种有益菌属的检测指数均偏低，需注意。
建议您：}}
\end{spacing}
...
\\
\includegraphics[scale=1.0]{xiaofangkuai.pdf}
{\fontsize{8pt}{11pt}\selectfont 建议适量补充益生菌。您可选择补充双歧杆菌活菌制剂、乳杆菌活菌制剂等益生菌产品，以增加您肠道内有益菌的含量，并能抑制有害菌的异常增殖，调节肠道菌群平衡。}
\end{spacing}
} \\
\hline
\parbox[c][4.7cm]{.95\hsize}{
