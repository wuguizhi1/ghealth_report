...
\parbox[c]{\hsize}{\vskip4pt{\color{black00} 消化和吸收\par \barial{INSUFFICIENCY}}\vskip4pt}\\\\[-5pt]
...
\medskip
\begin{tctabularx}{tabularx={p{3.33cm}}}
\parbox[c]{\hsize}{\vskip4pt{\color{black00} 炎症和免疫\par \barial{INFLAMMATION}}\vskip4pt}\\\\[-5pt]
\begin{minipage}[t][1.6cm][t]{3.33cm}
\color{black70}
...
\medskip
\begin{tctabularx}{tabularx={p{3.33cm}}}
\parbox[c]{\hsize}{\vskip4pt{\color{black00} 致病菌\par \barial{INFECTION}}\vskip4pt}\\\\[-5pt]
\begin{minipage}[t][1.6cm][t]{3.33cm}
\color{black70}
...
\medskip
\begin{tctabularx}{tabularx={p{3.33cm}}}
\parbox[c]{\hsize}{\vskip4pt{\color{black00} 代谢平衡\par \barial{IMBALANCE}}\vskip4pt}\\\\[-5pt]
\begin{minipage}[t][1.6cm][t]{3.33cm}
\color{black70}
...
\parbox[c]{\hsize}{\vskip4pt{\color{black00} 菌群多样性\par \barial{DIVERSITY ASSOCIATION}}\vskip4pt}\\
...
\parbox[c]{\hsize}{\vskip4pt{\color{black00} 相对丰度\par \barial{RELATIVE ABUNDANCE}}\vskip4pt}\\\\
%\begin{center}
...
%	\draw[fill=blue, blue] (3.5cm, 0.70cm) rectangle (5cm, 1.30cm) node {};%[xshift = -0.30cm,yshift=-4.5mm];
	...
	\draw (-2cm, -2.20cm - 0.40cm * 1) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Firmicutes~~厚壁菌门}};
	\draw[fill=solomon2, solomon2](-2.8cm, -2.20cm - 0.40cm * 2) rectangle (-2cm, -2.0cm - 0.40cm * 2);
	\draw (-2cm, -2.20cm - 0.40cm * 2) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Proteobacteria~~变形菌门}};
	\draw[fill=solomon3, solomon3](-2.8cm, -2.20cm - 0.40cm * 3) rectangle (-2cm, -2.0cm - 0.40cm * 3);
	\draw (-2cm, -2.20cm - 0.40cm * 3) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Cyanobacteria~~蓝藻门}};
	\draw[fill=solomon4, solomon4](-2.8cm, -2.20cm - 0.40cm * 4) rectangle (-2cm, -2.0cm - 0.40cm * 4);
	\draw (-2cm, -2.20cm - 0.40cm * 4) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Elusimicrobia~~Elusimicrobia}};
	\draw[fill=solomon5, solomon5](-2.8cm, -2.20cm - 0.40cm * 5) rectangle (-2cm, -2.0cm - 0.40cm * 5);
	\draw (-2cm, -2.20cm - 0.40cm * 5) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Tenericutes~~柔膜菌门}};
	\draw[fill=solomon6, solomon6](-2.8cm, -2.20cm - 0.40cm * 6) rectangle (-2cm, -2.0cm - 0.40cm * 6);
	\draw (-2cm, -2.20cm - 0.40cm * 6) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Actinobacteria~~放线菌门}};
	...
	\draw (1.5cm, -3.3cm) node[right, anchor = west, yshift=1.2mm] {\xiaosihao\color{gray2} {您的菌群相对丰度与}};
		\draw (1.5cm, -3.9cm) node[right, anchor = west, yshift=1.2mm] {\xiaosihao\color{gray2} {参考人群趋势一致}};
