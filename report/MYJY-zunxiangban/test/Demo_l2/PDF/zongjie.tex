...
%	\draw[fill=blue, blue] (3.5cm, 0.70cm) rectangle (5cm, 1.30cm) node {};%[xshift = -0.30cm,yshift=-4.5mm];
	...
	\draw (-2cm, -2.20cm - 0.40cm * 5) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Synergistetes~~互养菌门}};
	\draw[fill=solomon6, solomon6](-2.8cm, -2.20cm - 0.40cm * 6) rectangle (-2cm, -2.0cm - 0.40cm * 6);
	\draw (-2cm, -2.20cm - 0.40cm * 6) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Tenericutes~~柔膜菌门}};
