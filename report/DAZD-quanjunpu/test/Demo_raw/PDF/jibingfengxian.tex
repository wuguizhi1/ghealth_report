...
\hline
%\parbox[c]{\hsize}{\vskip7pt {\lantxh 结直肠癌\\ \bahao HASH(0x1fd98c0)} \vskip7pt} 
...
\hline
%\parbox[c]{\hsize}{\vskip7pt {\lantxh 炎症性肠病\\ \bahao HASH(0x1fd9a70)} \vskip7pt} 
...
\hline
%\parbox[c]{\hsize}{\vskip7pt {\lantxh 2型糖尿病\\ \bahao HASH(0x1fd9b90)} \vskip7pt} 
...
\hline
\multicolumn{2}{l}{}\\
\multicolumn{2}{l}{\hspace*{2mm}\includegraphics[scale=1]{greencircle.pdf} {\fontsize{9.03pt}{14pt}\selectfont\bf 绿色表示健康}\hspace*{2mm}\includegraphics[scale=1]{redcircle.pdf} {\fontsize{9.03pt}{14pt}\selectfont\bf 红色表示有风险}}
\end{longtable}
