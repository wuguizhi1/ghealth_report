...
#### 检测结果概况
&make_pdf($xml,"jiexi",$templateDir,$dirout,\@context1);

#### 检测结果概况
#&make_pdf($xml,"phylum",$templateDir,$dirout,\@context1);

#### 检测结果概况
&make_pdf($xml,"bacteria",$templateDir,$dirout,\@context1);

#### 检测结果概况
&make_pdf($xml,"zhibingjun",$templateDir,$dirout,\@context1);

#### 检测结果概况
&make_pdf($xml,"changjianjun",$templateDir,$dirout,\@context1);
