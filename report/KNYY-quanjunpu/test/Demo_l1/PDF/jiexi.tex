...
\begin{spacing}{1.25}
\noindent\fontsize{9pt}{11pt}\selectfont {您的肠道菌群组成较为单一，菌群失调风险高。您肠道内的有益菌含量较低，抑制有害菌增殖的能力较低。尽管您的有害菌含量也较低，但一旦有害菌异常大量增殖，可能引起感染、腹泻、肠炎、便秘等。有害菌数量过高还可能影响您的心情和食欲，扰乱内分泌，降低机体免疫力，增加疾病风险。请您改善饮食结构、规律作息，可适当补充益生菌，并持续监测肠道健康。}
