...
###
my ($datadir,$indir,$referdir,$dirout,$language,$barcode,$historydir,$confdir,$level_set,$host,$port,$database,$collection,$help,$updateadvice,$updateall);
GetOptions (
	"data=s"	=> \$datadir,
	"in=s"		=> \$indir,
	"referdir=s"	=> \$referdir,
...
$collection = $collection || "myjfyishengjun";
