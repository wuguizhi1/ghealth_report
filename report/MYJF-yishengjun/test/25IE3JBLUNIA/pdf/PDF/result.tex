...
\vspace*{3mm}
\begin{spacing}{1.5}
\noindent{\fontsize{10pt}{11pt}\selectfont\bf {1、主要益生菌检测结果}}
\end{spacing}
...
\hline
\parbox[c]{\hsize}{\vskip7pt 乳酸杆菌属（Lactobacillus） \vskip7pt} & 0 
{\includegraphics[scale=1]{redarrow_down.pdf}}
& ≥ 0.04 \\
\hline
\parbox[c]{\hsize}{\vskip7pt 双歧杆菌属（Bifidobacterium） \vskip7pt} & 0.24 
& ≥ 0.21 \\
\hline
\parbox[c]{\hsize}{\vskip7pt 阿克曼氏菌属（Akkermansia） \vskip7pt} & 0.01 
& ≥ 0.01 \\
\hline
\parbox[c]{\hsize}{\vskip7pt 柔嫩梭菌属（Faecalibacterium） \vskip7pt} & 116.97 
& ≥ 27.24 \\
\hline
\end{longtable}
...
\vspace*{3mm}
\begin{spacing}{1.5}
\noindent{\fontsize{10pt}{11pt}\selectfont\bf {2、检测结果分析}}

\vspace*{2mm}
{\indent\fontsize{9pt}{10pt}\selectfont 
您本次检测的4种主要益生菌中乳酸杆菌属（Lactobacillus）含量相比参考人群偏低。乳酸杆菌作为最知名的益生菌，是调节肠道环境的重要细菌，同时增强免疫力、抵抗病原菌、促进营养吸收等都有它的功劳。
这些菌属含量偏低，有可能导致免疫调节力下降、肠道环境差、抵抗病原菌能力降低，
\\\\
