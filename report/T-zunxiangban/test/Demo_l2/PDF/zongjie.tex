...
\color{black70}
{\qihao 蛋白质总量  \triangleb }\\
{\qihao 谷胱甘肽代谢  \triangleb }\\
{\qihao 牛磺酸代谢  \triangleb }\\
{\qihao 脂肪总量  \triangleb }\\
\end{minipage}
\\[-5pt]
...
\begin{minipage}[t][1.6cm][t]{3.33cm}
\color{black70}
{\qihao 异源物质降解  \triangleb }\\
{\qihao 毒素降解  \triangleb }\\
{\qihao 免疫指数  \triangleb }\\
{\qihao ~}\\
\end{minipage}
\\[-5pt]
\centerline{\includegraphics[width=2.15cm]{INFLAMMATION-red.pdf}}\\[-5pt]
\hspace*{0cm}\begin{minipage}[t][1.2cm][t]{3.3cm}{
\tikz\draw[topcolor,fill=topcolor](0,0) circle[radius=1pt];
\color{gray2}\qihao
您的异源物质降解、毒素降解、免疫指数指标异常。
}\end{minipage}\\
\centerline{\color{gray2}\rule{3cm}{0.5pt}}\\[-5pt]
\bahao
\noindent\begin{tabular}{@{}m{0.83cm}<{\centering}@{}m{0.83cm}<{\centering}@{}m{0.83cm}<{\centering}@{}m{0.83cm}<{\centering}@{}}
...
\begin{minipage}[t][1.6cm][t]{3.33cm}
\color{black70}
{\qihao 病原性大肠埃希氏菌  \triangleb }\\
{\qihao 脆弱拟杆菌  \triangleb }\\
{\qihao ~}\\
{\qihao ~}\\
\end{minipage}
\\[-5pt]
...
\begin{minipage}[t][1.6cm][t]{3.33cm}
\color{black70}
{\qihao 维生素B1  \triangleb }\\
{\qihao 维生素B2  \triangleb }\\
{\qihao 维生素B3  \triangleb }\\
{\qihao 维生素B5  \triangleb }\\
\end{minipage}
\\[-5pt]
\centerline{\includegraphics[width=2.15cm]{IMBALANCE-red.pdf}}\\[-5pt]
\hspace*{0cm}\begin{minipage}[t][1.2cm][t]{3.3cm}{
\tikz\draw[topcolor,fill=topcolor](0,0) circle[radius=1pt];
\color{gray2}\qihao
%您的维生素B1、维生素B2、维生素B3等指标异常。
您的重要小分子代谢检测出10项异常指标。
}\end{minipage}\\
\centerline{\color{gray2}\rule{3cm}{0.5pt}}\\[-5pt]
\bahao
...
\put(3, -146){\raisebox{52.47pt}{\includegraphics[scale=0.85]{DIVERSITY-low.pdf}}}
\end{picture}
\end{center}
}
\\\\\\\\\\\\\\[-7pt]
...
\begin{tikzpicture}[bar interval width=0.8, bar width=0.70cm]
	...
	\draw[fill=solomon5, solomon5] (0.965709753cm * 5, -0.30cm) rectangle (0.965851738cm * 5, 0.30cm) node {};
	\draw[fill=solomon6, solomon6] (0.965851738cm * 5, -0.30cm) rectangle (0.978026628cm * 5, 0.30cm) node {};
...
%	\draw[fill=blue, blue] (3.5cm, 0.70cm) rectangle (5cm, 1.30cm) node {};%[xshift = -0.30cm,yshift=-4.5mm];
	...
	\draw (-2cm, -5.00cm + 0.40cm * 5) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Synergistetes~~互养菌门}};
	\draw[fill=solomon6, solomon6](-2.8cm, -5.00cm + 0.40cm * 6) rectangle (-2cm, -4.8cm + 0.40cm * 6);
	\draw (-2cm, -5.00cm + 0.40cm * 6) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Actinobacteria~~放线菌门}};
