...
\medskip
\noindent
{\liuhao 质地：~\includegraphics[scale=0.6]{texture_part4.pdf}  ~~颜色：~\includegraphics[scale=0.7]{color_part4.pdf}}
...
\end{minipage}
\\[-5pt]
\centerline{\includegraphics[width=2.15cm]{INFLAMMATION-yellow.pdf}}\\[-5pt]
...
\parbox[c]{\hsize}{\vskip4pt{\tikz\draw[topcolor,fill=topcolor](0,0) circle[radius=1pt];\color{gray2}\qihao 您的菌群多样性仅高于0.14{\%}的参考人群}\\}
\parbox[c]{\hsize}{
\begin{center}
\begin{picture}(1, 1)
\put(-70, -165){\includegraphics[width=4.70cm]{DIVERSITY-ASSOCIATION.pdf}}
\put(3, -146){\raisebox{0.14pt}{\includegraphics[scale=0.85]{DIVERSITY-low.pdf}}}
\end{picture}
\end{center}
}
\\\\\\\\\\\\\\[-7pt]
...
\begin{tikzpicture}[bar interval width=0.8, bar width=0.70cm]
	...
	\draw[fill=solomon0, solomon0] (0cm * 5, -0.30cm) rectangle (0.07363052cm * 5, 0.30cm) node {};
	\draw[fill=solomon1, solomon1] (0.07363052cm * 5, -0.30cm) rectangle (0.53750432cm * 5, 0.30cm) node {};
	\draw[fill=solomon2, solomon2] (0.53750432cm * 5, -0.30cm) rectangle (0.96469122cm * 5, 0.30cm) node {};
	\draw[fill=solomon3, solomon3] (0.96469122cm * 5, -0.30cm) rectangle (0.965864603cm * 5, 0.30cm) node {};
	\draw[fill=solomon4, solomon4] (0.965864603cm * 5, -0.30cm) rectangle (0.984765773cm * 5, 0.30cm) node {};
	\draw[fill=solomon5, solomon5] (0.984765773cm * 5, -0.30cm) rectangle (0.985784306cm * 5, 0.30cm) node {};
	\draw[fill=solomon6, solomon6] (0.985784306cm * 5, -0.30cm) rectangle (0.997959196cm * 5, 0.30cm) node {};
...
%	\draw[fill=blue, blue] (4cm, -0.30cm) rectangle (5cm, 0.30cm) node {};%[xshift = -0.45cm,yshift=-4.5mm];
	...
	\draw[fill=solomon0, solomon0] (0cm * 5, 0.70cm) rectangle (0.6380354cm * 5, 1.30cm) node {};
	\draw[fill=solomon1, solomon1] (0.6380354cm * 5, 0.70cm) rectangle (0.9229312cm * 5, 1.30cm) node {};
	\draw[fill=solomon2, solomon2] (0.9229312cm * 5, 0.70cm) rectangle (0.98761724cm * 5, 1.30cm) node {};
	\draw[fill=solomon3, solomon3] (0.98761724cm * 5, 0.70cm) rectangle (0.996858103cm * 5, 1.30cm) node {};
	\draw[fill=solomon4, solomon4] (0.996858103cm * 5, 0.70cm) rectangle (0.999306932cm * 5, 1.30cm) node {};
	\draw[fill=solomon5, solomon5] (0.999306932cm * 5, 0.70cm) rectangle (0.9996765665cm * 5, 1.30cm) node {};
	\draw[fill=solomon6, solomon6] (0.9996765665cm * 5, 0.70cm) rectangle (0.9999075881cm * 5, 1.30cm) node {};
...
%	\draw[fill=blue, blue] (3.5cm, 0.70cm) rectangle (5cm, 1.30cm) node {};%[xshift = -0.30cm,yshift=-4.5mm];
	...
	\draw (-2cm, -2.20cm - 0.40cm * 0) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Proteobacteria~~变形菌门}};
	\draw[fill=solomon1, solomon1](-2.8cm, -2.20cm - 0.40cm * 1) rectangle (-2cm, -2.0cm - 0.40cm * 1);
	\draw (-2cm, -2.20cm - 0.40cm * 1) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Bacteroidetes~~拟杆菌门}};
	...
	\draw (-2cm, -2.20cm - 0.40cm * 3) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Verrucomicrobia~~疣微菌门}};
	\draw[fill=solomon4, solomon4](-2.8cm, -2.20cm - 0.40cm * 4) rectangle (-2cm, -2.0cm - 0.40cm * 4);
	\draw (-2cm, -2.20cm - 0.40cm * 4) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Fusobacteria~~梭杆菌门}};
	\draw[fill=solomon5, solomon5](-2.8cm, -2.20cm - 0.40cm * 5) rectangle (-2cm, -2.0cm - 0.40cm * 5);
	\draw (-2cm, -2.20cm - 0.40cm * 5) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Cyanobacteria~~蓝藻门}};
