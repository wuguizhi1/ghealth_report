...
\draw[fill=topcolor,color=topcolor,very thick] (0,0) -- (\filltopaa*1mm,0) -- (\filltopaa*1mm,2.8mm) -- (0,2.8mm);
...
\draw[fill=topcolor,color=topcolor,very thick] (0,0) -- (\filltopbb*1mm,0) -- (\filltopbb*1mm,2.8mm) -- (0,2.8mm);
\path (30mm,1.4mm) node [right=0mm] {\filltopb};
\end{scope}

\end{tikzpicture}
\begin{center}
\includegraphics[width=.35cm]{xiaoren08.pdf}
\pdfchatu{xiaoren0}{9}

\textbf{\small 您的有益菌含量高于8.32{\%}的参考人群 }
\end{center}
\end{minipage}
\hfill
\begin{minipage}[t]{.47\textwidth}
...
\begin{center}
\pdfchatuorange{xiaoren1}{9}\includegraphics[width=.35cm]{xiaoren18.pdf}

\textbf{\small 您的有害菌含量高于98.33{\%}的参考人群}
\end{center}
\end{minipage}
...
\asidebreak %
您肠道内的有害菌含量偏高，会产生毒素等有害物质，可能会引起口臭、感染、腹泻、肠炎、便秘等。有害菌数量过高还可能影响您的心情和食欲，扰乱内分泌，降低机体免疫力，增加疾病风险。同时您肠道内的有益菌含量较低，抑制有害菌增殖的能力较低，请您改善饮食结构、规律作息，补充益生菌，并持续监测肠道健康。
\end{LRaside}
