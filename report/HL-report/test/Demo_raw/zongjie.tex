...
\medskip
\noindent
{\liuhao 质地：~\includegraphics[scale=0.6]{}  ~~颜色：~\includegraphics[scale=0.7]{}}
...
\parbox[c]{\hsize}{\vskip4pt{\color{black70} \par \barial{}}\vskip4pt}\\\\[-5pt]
...
\end{minipage}
\\[-5pt]
\centerline{\includegraphics[width=2.15cm]{}}\\[-5pt]
...
\includegraphics[width=.45cm]{} & \tikz\draw[gray,fill=gray](0,0) circle[radius=4.5pt]; & \tikz\draw[gray,fill=gray](0,0) circle[radius=4.5pt]; & \tikz\draw[gray,fill=gray](0,0) circle[radius=4.5pt];\\
...
\parbox[c]{\hsize}{\vskip4pt{\tikz\draw[topcolor,fill=topcolor](0,0) circle[radius=1pt];\color{gray2}\qihao 您的菌群多样性高于{\%}的参考人群}\\}
\parbox[c]{\hsize}{
\begin{center}
\begin{picture}(1, 1)
\put(-70, -165){\includegraphics[width=4.70cm]{DIVERSITY-ASSOCIATION.pdf}}
\put(3, -146){\raisebox{pt}{\includegraphics[scale=0.85]{}}}
\end{picture}
\end{center}
}
\\\\\\\\\\\\\\[-7pt]
...
%	\draw[fill=blue, blue] (3.5cm, 0.70cm) rectangle (5cm, 1.30cm) node {};%[xshift = -0.30cm,yshift=-4.5mm];
	...
	\draw (-2cm, -2.20cm - 0.40cm * 4) node[left, anchor = west, yshift=1.2mm] {\wudianwu\color{gray2} {Elusimicrobia~~迷踪菌门}};
