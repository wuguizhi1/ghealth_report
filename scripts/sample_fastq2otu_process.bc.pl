...
# qiime assign taxon
$cmd = "docker run --rm -v $out_dir/:$out_dir/ -v /data/bioit/biodata/liuy/16s/amplicon-pip/database/fungus/:/data/bioit/biodata/liuy/16s/amplicon-pip/database/fungus/ qiime:1.9.1 assign_taxonomy.py -i $out_dir/$lable.otus.nonchimera.fasta -o $out_dir/assigned_taxonomy ";
$cmd .= "-t /data/bioit/biodata/liuy/16s/amplicon-pip/database/fungus/sh_taxonomy_qiime_ver7_97_s_01.12.2017.txt ";
$cmd .= "-r /data/bioit/biodata/liuy/16s/amplicon-pip/database/fungus/sh_refs_qiime_ver7_97_s_01.12.2017.fasta ";
$cmd .= "-m $para{assign_m}";
